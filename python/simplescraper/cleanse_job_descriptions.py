...
def cleanse_job_descriptions(load_timestamp, target_date):
    configure_logger(load_timestamp, 'parse_job_descriptions')
    df = list_downloaded_job_descriptions(load_timestamp, target_date)
    if df.empty:
...
if __name__ == "__main__":
    ...
    cleanse_job_descriptions(_load_timestamp, _target_date)
