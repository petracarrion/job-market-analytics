...
def list_job_descriptions_to_download(run_id, df_sitemap_urls, df_downloaded):
    ...
    save_temp_df(df, run_id, JOB_DESCRIPTIONS_TO_DOWNLOAD_CSV)
    return df
...
if __name__ == "__main__":
    list_job_descriptions_to_download(
        LATEST_RUN_ID,
        load_temp_df(LATEST_RUN_ID, SITEMAP_URLS_CSV),
